/***********************************************************
 * Name: Codi Chun
 * Practiced the use of map, filter and reduce
************************************************************/
...
function genId(){
  return getRandomInt(9_000_000, 9_999_999);
}
...
const genStudentObject = (student) => ({name: student, id: genId()});
...
const firstStudent = studentObjects.reduce((min, x) => x.studentID < min.studentID ? x : min);
 ...
 * ~ HINT: You will NOT be able to rely on default parameters
 *         of the reduce function! - think about Jd's question in lecture.
 **************************************************************************/

const countTcss = setStudents.reduce((count, x) => x.major=='TCSS'?count+1:0);
